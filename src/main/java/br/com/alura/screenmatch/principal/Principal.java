...
public class Principal {
    ...
    private final String API_KEY = "&apikey=7269c0c0";
    ...
    public void exibeMenu() {
        ...
        System.out.println("Digite um trecho do título do epidódio");
...
//                ));
        ...
        Map<Integer, Double> avalizacoesPorTemporada = episodios.stream()
                .filter(e -> e.getAvaliacao() > 0.0)
                .collect(Collectors.groupingBy(Episodio::getTemporada, Collectors.averagingDouble(Episodio::getAvaliacao)));
        System.out.println(avalizacoesPorTemporada);
